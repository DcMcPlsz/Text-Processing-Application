/*
 *         An ACTIVE filter interface, takes data from an input pipe, transforms it
 ...
 *
 *         This constraint must be strictly followed because the creation of a
 *         filter
 *         and its input/output pipes is done dynamically through the Java
 *         reflection API
