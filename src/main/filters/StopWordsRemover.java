...
public class StopWordsRemover extends UntypedActor {
    ...
    public static String[] STOP_WORDS = { "a", "able", "about", "above", "abst", "accordance", "according",
            ...
            "effect", "eg", "eight", "eighty", "either", "else", "elsewhere", "end", "ending", "enough", "especially",
            "et", "et-al", "etc", "even", "ever", "every", "everybody", "everyone", "everything", "everywhere", "ex",
            ...
            "himself", "his", "hither", "home", "how", "howbeit", "however", "hundred", "i", "id", "ie", "if", "i'll",
