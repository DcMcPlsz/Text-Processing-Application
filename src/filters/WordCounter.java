 ...
 */
public class WordCounter implements Filter<String, TermFrequency> {
    ...
    public WordCounter(Pipe<String> input, Pipe<TermFrequency> output, CountDownLatch doneSignal) {
        this.input = input;
        this.output = output;
        ...
        while(true) {
            ...
            try {
                ...
                if(word.equals(Configuration.SENTINEL_VALUE)) {
                    tf.term = Configuration.SENTINEL_VALUE;
